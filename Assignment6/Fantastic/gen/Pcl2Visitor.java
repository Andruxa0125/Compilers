...
public interface Pcl2Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Pcl2Parser#declList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclList(Pcl2Parser.DeclListContext ctx);
	/**
	 * Visit a parse tree produced by {@link Pcl2Parser#decl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDecl(Pcl2Parser.DeclContext ctx);
	/**
